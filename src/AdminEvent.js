...
export const EventList = props => (
    <List {...props}>
        <Datagrid>
            ...
            <ReferenceField source="place_id" reference="places"><TextField source="building" /></ReferenceField>
...
export const EventEdit = props => (
    <Edit {...props}>
        <SimpleForm>
            ...
            <ReferenceInput source="place_id" reference="places"><SelectInput optionText="building" /></ReferenceInput>
