...
import { Grid, Icon, Button, Input, Item, Card, Image,Form } from 'semantic-ui-react';
        ...
        <Grid divided="vertically">
          ...
          <Card style={{width:"90%", margin:"10px"}}>
            ...
            <Item>
                ...
                <Item.Header> <h2>{student.name} {student.second_name}</h2></Item.Header> 
                  </center>
                  <Form onSubmit={this.saveProfile}>
                      ...
                      <Form.Input
                        name='studentGroups'
                        label={ <label style={labelstyle}>Grupos Estudiantiles: </label> }
                        placeholder=''
                        readOnly={edit}
                      ...
                      />
                        ...
                        {!edit ?
                          <Button type="submit">NEPE</Button> : null
                        }
                  </Form>
